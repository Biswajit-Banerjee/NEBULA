...
const tourSteps = [
  ...
  /* ── 7  Backtrace tree ── */
  {
    ...
    body: `This AND-OR tree shows the biosynthetic lineage of your target. Each branch is a reaction that can produce it, and sub-branches trace further back. The "Minimal Pathways" panel lists the shortest complete routes.`,
    placement: 'top-right',
    action: 'view-tree',
    features: [
      'Click nodes to expand or collapse branches',
      'Browse minimal pathways in the side panel',
